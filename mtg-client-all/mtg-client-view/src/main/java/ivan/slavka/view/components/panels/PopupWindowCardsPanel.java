...
public class PopupWindowCardsPanel extends JPanel{
	...
	public PopupWindowCardsPanel(String borderName, MTGClientPanel viewController) {
	...
	public void addItem(CardBeanWrapper cardBean){
		...
		this.add(new CardButton(this.viewController, cardBean, null), "cell " + this.numberOfCardsInRow + " " + this.numberOfrows);
